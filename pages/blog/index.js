                ...
                {props.blogs.map((blog, idx) => {
                  return (
                    <Link href={`/blog/${blog.slug}`} key={idx}>
                      <a class="max-w-sm bg-white m-auto item-center shadow-lg rounded-lg overflow-hidden my-4 transition duration-500 ease-in-out transform hover:-translate-y-1 hover:scale-110">
                        <img
                        ...
                        <div class="flex items-center px-6 py-3 bg-gray-900">
                          {blog.icon == "javascript" ? (
                            <svg
                              ...
                              viewBox="0 0 48 48"
                              class="h-7 w-7 text-white fill-current"
                            >
