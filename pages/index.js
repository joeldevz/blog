          ...
          <section className="bg-gray-800 pattern py-20">
            <div className="max-w-5xl px-6 mx-auto text-center">
              ...
              <p className="text-gray-50 my-4">
                Actualmente me sigo
                formando diariamente en <b>JavaScript, Python, NodeJS</b> y en
                otras tecnologías como <b> Next.JS, React, MongoDB</b>. Me
                encanta compartir mis conocimientos, durante varios meses he
                dado <b> clases de programación.</b> Y ahora he decidido
                hacer que mis conocimientos lleguen a más personas.
